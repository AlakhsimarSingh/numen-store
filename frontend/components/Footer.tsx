...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 bg-surface">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-7 px-6 pb-4 pt-4">
        <ContactPrompt />
        <SocialLinks />

        <div className="-mt-2 flex w-full flex-col items-center justify-between gap-2 border-t border-white/5 pt-3 sm:flex-row">
